 ...
 */
@Data
public class BusAnswerExample extends BaseExample {
    ...
    static {
        ...
        modelInfo.put("isRight", "is_right");
    ...
    protected abstract static class GeneratedCriteria {
        ...
        /**
         * 添加isRightis not null条件对象，并返回条件对象
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
         */
        ...
        /**
         * 添加isRight between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
        ...
        /**
         * 添加isRight not between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
