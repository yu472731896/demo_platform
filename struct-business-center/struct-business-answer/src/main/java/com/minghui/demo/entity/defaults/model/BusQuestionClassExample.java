 ...
 */
@Data
public class BusQuestionClassExample extends BaseExample {
    ...
    static {
        ...
        modelInfo.put("parentId", "parent_id");
        modelInfo.put("parentIds", "parent_ids");
     ...
     * @since 1.0.0
     */
    public BusQuestionClassExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        /**
         * 添加parentIdis not null条件对象，并返回条件对象
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
         */
        ...
        /**
         * 添加parentId between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
        ...
        /**
         * 添加parentId not between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
        ...
        /**
         * 添加parentIdsis null条件对象，并返回条件对象
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
         */
        ...
        /**
         * 添加parentIdsis not null条件对象，并返回条件对象
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
         */
        ...
        /**
         * 添加 parentIds like value条件对象，并返回对象
         * @param value 条件值
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
        ...
        /**
         * 添加 parentIds not like value条件对象，并返回对象
         * @param value 条件值
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
         * @since 1.0.0
        ...
        /**
         * 添加parentIds between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
        ...
        /**
         * 添加parentIds not between value1 and value2条件对象，并返回条件对象
         * @param value1 左区间
         * @param  value2 右区间
         * @return 条件对象
         * @author ThinkPad 2020-08-20 14:17
