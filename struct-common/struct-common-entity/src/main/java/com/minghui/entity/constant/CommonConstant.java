package com.minghui.entity.constant;
...
public class CommonConstant {
	...
	public static class MoudelName {
		 ...
		 * AR标注访问记录
		 */
		public static final String MARK_INFO = "27";

		/**
		 * 行政区划
		 */
		public static final String GRID_INFO = "28";

		/**
		 * 房屋管理
		 */
		public static final String HOUSE_INFO = "29";
